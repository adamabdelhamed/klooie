...
public class AutoTargetingFunction : Lifetime
{
    ...
    private void Evaluate()
    {
        ...
        {
            if (Game.Current.GamePanel.IsInView(element) == false) continue;
            ...
            var prediction = CollisionDetector.Predict(new ColliderBox(sb), angle, obstacles, 3 * Game.Current.GamePanel.Bounds.Hypotenous, CastingMode.Rough, edgesHitOutput: edgesHitOutput);
