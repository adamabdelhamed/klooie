...
- `../klooie.blazorSampleApp/Properties/launchSettings.json`: VS launch profile for serving the packaged static output with Python on port 5187. VS launches from `bin/<Configuration>/net10.0`, so the profile serves `..\..\klooie.web`.
