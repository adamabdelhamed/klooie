...
public static class ElecrticGuitar
{
    ...
    */
    ...
    public static ISynthPatch CreateStereoLayeredGuitar() => LayeredPatch.CreateBuilder()
        .AddLayer(volume: 0.6f, pan: -0.6f, transpose: 0, patch: SynthPatch.Create()
            ...
            .WithReverb(0.24f, 0.22f, 0.20f, 0.7f)
        ...
        .AddLayer(volume: 0.48f, pan: +0.6f, transpose: 12, patch: SynthPatch.Create()
            ...
            .WithReverb(0.17f, 0.23f, 0.22f, 0.82f)
        ...
        .AddLayer(volume: 0.38f, pan: 0.0f, transpose: 0, patch: SynthPatch.Create()
            ...
            .WithReverb(0.13f, 0.13f, 0.17f, 0.81f)
